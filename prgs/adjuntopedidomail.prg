FUNCTION Shellsendto
LPARAMETERS tcFile, tcDestinatario , tcBody

cMessageTitle = 'Procedimiento de Envio por Email Express'
cMessageText = 'Desea Mandar el Pedido: '+tcFile +'.Para el destinatario: '+tcDestinatario+'?'
...
*MESSAGEBOX("Pedido a Enviar a " + tcTo + " Asunto " + tcSubject + "adjunto  " + tcFile , 64)
...
WITH loMail
	...
	.nAuthenticate = 1 	&& cdoBasic
 	.cUserName = "oryproveedores@gmail.com"
	.cPassword = "ailiniara"
 
	*.cFrom = "yourlAccount@live.com"
 	.cFrom = .cUserName
 
	.cTo = tcDestinatario && "somebody@otherdomain.com, somebodyelse@otherdomain.com"
...
IF loMail.Send() > 0
	...
	ENDFOR
ELSE
	MESSAGEBOX("Email Enviado exitosamente.")
ENDIF
